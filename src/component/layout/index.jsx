...
const menu = (
	<Menu>
		<MenuItem key="1"><Icon type="logout" /><span>退出登录</span></MenuItem>
	</Menu>
);
const openKeysObj = {
	product: ['sub1-1'],
						...
						<div className="welcomeAdmin">
							<Dropdown overlay={menu} trigger={['click']}>
								<span className="adminButton">
									<Icon type="user" style={{marginRight: 5}}/><span>欢迎, admin</span><Icon type="caret-down" style={{marginLeft: 5, fontSize: 12}} />
								</span>
							</Dropdown>
						</div>
					</Header>
